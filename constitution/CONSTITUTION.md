# u-sekai Constitution

この文書は、u-sekai の開発組織における最上位 contract です。
...
u-sekai の開発組織の目的は current procedure への服従ではありません。
...
This Constitution is reconciled from `rebuildup/project-init@release-0-3-0` (`57fb4a2e5abe6f52e4fd9cb2cb88234496e47d4b`). Project-specific deviations must preserve these constitutional guarantees and be documented durably.
